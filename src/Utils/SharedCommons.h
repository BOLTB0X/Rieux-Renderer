...
namespace SharedCommons {
    ...
    inline const std::wstring GBUFFER_PS = L"HLSL/GPU_GBufferPS.hlsl";
    inline const std::string  GBUFFER_PS_STR = "GBuffer_PS";

    inline const std::wstring PREFILTER_ENVIRONMENT_CS = L"HLSL/PrefilterEnvironmentCS.hlsl";
    inline const std::string  PREFILTER_ENVIRONMENT_CS_STR = "PrefilterEnvironmentCS";

    inline const std::wstring BRDF_INTEGRATION_CS = L"HLSL/BRDFIntegrationCS.hlsl";
    inline const std::string  BRDF_INTEGRATION_CS_STR = "BRDFIntegrationCS";
} // HLSL
